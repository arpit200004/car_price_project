...
def generate_symmetric_cars(n_samples=5000):
    ...
    models = [
        ...
        {"brand": "Maruti", "model": "Maruti Fronx", "body": "suv", "fuel": "petrol", "engine": "1197 cc", "power": "88.50 bhp", "torque": "113 Nm", "seats": 5, "length": "3995", "width": "1765", "height": "1550", "price_base": 1050000,
         "variants": ["Sigma", "Delta", "Delta+", "Zeta", "Alpha"]},
        {"brand": "Maruti", "model": "Maruti Grand Vitara", "body": "suv", "fuel": "petrol", "engine": "1462 cc", "power": "101.64 bhp", "torque": "136.8 Nm", "seats": 5, "length": "4345", "width": "1795", "height": "1645", "price_base": 1600000,
         "variants": ["Sigma", "Delta", "Zeta", "Alpha"]},
        {"brand": "Maruti", "model": "Maruti Brezza", "body": "suv", "fuel": "petrol", "engine": "1462 cc", "power": "101.65 bhp", "torque": "136.8 Nm", "seats": 5, "length": "3995", "width": "1790", "height": "1685", "price_base": 1300000,
         "variants": ["LXi", "VXi", "ZXi", "ZXi+"]},
        {"brand": "Maruti", "model": "Maruti Ertiga", "body": "muv", "fuel": "petrol", "engine": "1462 cc", "power": "101.65 bhp", "torque": "136.8 Nm", "seats": 7, "length": "4395", "width": "1735", "height": "1690", "price_base": 1350000,
         "variants": ["LXi", "VXi", "ZXi", "ZXi+"]},
        {"brand": "Maruti", "model": "Maruti Swift", "body": "hatchback", "fuel": "petrol", "engine": "1197 cc", "power": "88.50 bhp", "torque": "113 Nm", "seats": 5, "length": "3845", "width": "1735", "height": "1530", "price_base": 950000,
         "variants": ["LXi", "VXi", "ZXi", "ZXi+"]},
        
        {"brand": "Hyundai", "model": "Hyundai Exter", "body": "suv", "fuel": "petrol", "engine": "1197 cc", "power": "81.80 bhp", "torque": "113.8 Nm", "seats": 5, "length": "3815", "width": "1710", "height": "1631", "price_base": 950000,
         "variants": ["EX", "S", "SX", "SX (O)"]},
        {"brand": "Hyundai", "model": "Hyundai Creta", "body": "suv", "fuel": "petrol", "engine": "1497 cc", "power": "113.18 bhp", "torque": "143.8 Nm", "seats": 5, "length": "4330", "width": "1790", "height": "1635", "price_base": 1700000,
         "variants": ["E", "EX", "S", "SX", "SX (O)"]},
        
        {"brand": "Mahindra", "model": "Mahindra Scorpio-N", "body": "suv", "fuel": "diesel", "engine": "2198 cc", "power": "172.45 bhp", "torque": "400 Nm", "seats": 7, "length": "4662", "width": "1917", "height": "1857", "price_base": 2700000,
         "variants": ["Z2", "Z4", "Z6", "Z8", "Z8L"]},
        {"brand": "Mahindra", "model": "Mahindra XUV700", "body": "suv", "fuel": "petrol", "engine": "1997 cc", "power": "197.13 bhp", "torque": "380 Nm", "seats": 7, "length": "4695", "width": "1890", "height": "1755", "price_base": 2600000,
    ...
    for _ in range(n_samples):
        ...
        year = random.choices([2023, 2024], weights=[0.4, 0.6])[0]
        ...
        row = {
            ...
            "owner_type": "first" if year==2024 else random.choices(["first", "second"], weights=[0.9, 0.1])[0],
    ...
    out_path = Path(__file__).parent / "synthetic_2024_cars.csv"
